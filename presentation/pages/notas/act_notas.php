...
<body class="bg-gray-100 font-sans leading-normal tracking-normal flex items-center justify-center h-screen">
  ...
  <main class="w-full max-w-md">
    <h2 class="text-2xl font-bold mb-4 text-gray-800 text-center">Actualizar Nota</h2>

    <!-- Formulario de Actualizar Nota -->
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <form id="update-nota-form">
        ...
        <div class="flex items-center justify-between">
          <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Actualizar Nota</button>
        </div>
      </form>
    </div>
  </main>
  ...
  <script src="../../scripts/act_notas.js"></script>
</body>
</html>
